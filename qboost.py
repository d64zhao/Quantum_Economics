...
def qboost_lambda_sweep(X, y, lambda_vals, val_fraction=0.1, verbose=False, **kwargs):
    ...
    for lam in lambda_vals:
        ...
        for r_seed in [1,2,3]:
            ...
            score_cv = qb.score(X_val, y_val)
            print(f'trial {r_seed} for lambda {lam} gave score {score_cv}')
            score_list.append(score_cv)
