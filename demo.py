...
if __name__ == '__main__':
    ...
    proxies = {
      'http': 'http://m031650:PwdBi21$@itaca-prod.utenze.bankit.it:8080',
      'https': 'http://m031650:PwdBi21$@itaca-prod.utenze.bankit.it:8080',
    }
    ...
    sp_digits = subparsers.add_parser(
        'german', help='german credit data set')
    ...
    if args.dataset == 'blobs':
        ...
        if args.cross_validation:
            ...
            qboost = QBoostClassifier(X_train, y_train, 0.005)
        ...
        print('Selected features:',
              qboost.get_selected_features())
        print('Score on test set: {:.3f}'.format(qboost.score(X_test, y_test)))
        print('Value of lambda: {:.3f}'.format(lam))
